    ...
    >
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <div>
          ...
          <p className="text-2xl font-bold" style={{ fontVariantNumeric: 'tabular-nums', color: colA.color }}>
            {formatINR(animA)}
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-2xl font-bold" style={{ fontVariantNumeric: 'tabular-nums', color: colB.color }}>
            {formatINR(animB)}
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-2xl font-bold" style={{ fontVariantNumeric: 'tabular-nums', color: colC.color }}>
